document.addEventListener("DOMContentLoaded", () => {
  ...
  importFile?.addEventListener("change",async()=>{
    ...
    try{
      ...
      showButtonState(importButton,"Імпортовано","success",1500);logAction(`Імпортовано ${products.length} продуктів${hasArchive?` і ${archiveItems.length} записів КБЖВ-архіву`:"; КБЖВ-архів не змінювався"}.`);
